          ...
          <div className="space-y-3">
            <div className="rounded-md border border-gray-200 bg-white p-4 text-sm text-gray-700">
              ...
              <div className="mt-2 max-h-40 overflow-y-auto leading-6">
                ...
                <p>
                  서비스 이용을 위해 이메일 주소, 비밀번호, 닉네임 및 회원 식별값을
                  처리합니다. 비밀번호는 인증 서비스 제공자를 통해 안전하게 처리되며,
                  서비스 운영자는 비밀번호 원문을 확인하거나 저장하지 않습니다.
                </p>
                <p className="mt-3 font-medium text-gray-900">2. 자동 수집 및 서비스 이용 기록</p>
                <p>
                  질문·답변 제공, 이용 내역 확인, 통계 분석 및 커리큘럼 개선을 위해
                  검색 기록을 수집합니다. 검색 기록에는 회원 식별값, 질문 및 검색어,
                  검색 시각, 답변 내용 또는 요약이 포함될 수 있습니다.
                </p>
                ...
                <p>
                  본 서비스는 사용자의 질문과 검색 기록을 별도 모델 학습 목적으로
                  사용하지 않습니다. 질문에 첨부된 이미지는 답변 생성 과정에서만
                  일시적으로 처리하며 서비스 데이터베이스나 파일 저장소에 별도로
                  저장하지 않습니다.
                </p>
                <p className="mt-3 font-medium text-gray-900">5. 개인정보 보관 기간</p>
                <p>
                  이메일, 닉네임, 회원 식별값, 인증정보, 크레딧 및 이용 기록과 해당
                  회원의 질문·검색·답변 기록은 회원 탈퇴 시 지체 없이 삭제합니다.
                  질문에 첨부된 이미지는 답변 처리 중에만 일시적으로 처리하고 별도로
                  보관하지 않습니다. 단, 관계 법령에 따라 보관이 필요한 정보는 해당
                  법령에서 정한 기간 동안 다른 개인정보와 분리하여 보관합니다.
                </p>
